...
1.  Become familiar with the BIOL4110 website and syllabus.
...
-   Overview of coding a data analysis: [STAT 545 Episode 1-A: Coding your Analysis for Success](https://youtu.be/91LmBj29-Sc)
-   Practice some R syntax and jupyter: Worksheet A1 ([.ipynb](https://github.com/BIOL4110/BIOL4110-course-website/blob/main/content/worksheets/worksheet_a01.ipynb))
...
-   Joey (instructor): [https://www.bernhardtlab.org/](https://www.bernhardtlab.org/)
-   TA: Jelany Duali
...
1.  Slack (<https://biol4110.slack.com/>)
...
2.  Website (<https://github.com/BIOL4110/BIOL4110-course-website>) -- view this as your "launchpad".

3.  A GitHub Organization for you to submit homework and projects to.

4.  Courselink (for grade management and worksheet submission)
...
Worksheet A1 ([.ipynb](https://github.com/BIOL4110/BIOL4110-course-website/blob/main/content/worksheets/worksheet_a01.ipynb)) is an **autograded!** worksheet covering some R basics. Let's go through some of it. *You won't be submitting this worksheet for a grade, but future worksheets will count towards your grade.*.
...
*(Thanks to Jenny Bryan and her team for writing the majority of this, Katie Burak and the STAT 545 teaching team)*
