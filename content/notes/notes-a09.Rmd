...
If you can't extract model information from built-in functions like `coef()` or `sigma()`, you can manually dig in to the model object. In most cases, a model object is just a list in disguise! You can therefore extract information like you would with any other list.
