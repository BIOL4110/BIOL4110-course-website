...
To follow along, download [demonstration .Rmd file](https://github.com/BIOL4110/BIOL4110-course-website/blob/main/content/notes/mtcars_demonstration.Rmd) and open it in RStudio.
...
5. Fill in the document with markdown commentary for each of the code chunks! A few notes go a long way towards improving the readability of the report. 
