...
An important part of data analysis is simply checking the data for things like: 
...
Put any questions you have about the worksheet questions or about data manipulation in general to the all-biol4110 Slack channel.

### Remaining time in Class 1

Teaching team will go over the questions in Slack. 
