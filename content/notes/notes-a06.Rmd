...
- [Visualization Analysis and Design](https://www.cs.ubc.ca/~tmm/vadbook/) by Tamara Munzner is a gold-standard book for the theory of designing plots with a focus on human perception.
...
We recommend an R package called `ggplot2`, which provides a very powerful and relatively simple framework for making plots. Plus, it has a theoretical underpinning, based on the Grammar of Graphics, first described by Leland Wilkinson in his ["Grammar of Graphics" book](https://link.springer.com/book/10.1007/0-387-28695-0). With `ggplot2`, you can make a great many type of plots with minimal code. It's been a hit in and outside of the R community.
...
Put any questions you have about the worksheet questions or about graphing in general in the Slack. 

### Remaining time in Class 1

Teaching team will go over the questions in the Slack. 
