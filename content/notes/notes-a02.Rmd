...
**Example 1**: [Joey's postdoc project](https://github.com/JoeyBernhardt/chlamee-r-star)

**Example 2**: [The BIOL4110 course repository](https://github.com/BIOL4110/BIOL4110-course-website)

 The first repository lives under Joey's personal Github account. The second repository  lives under the [BIOL4110](https://github.com/BIOL4110) organization. Organizations are useful if you have lots of different projects with a common theme which lots of people are collaborating on.

### Useful Github tips for the course

-  All of your projects in this class will live in the [BIOL4110 Organization](https://github.com/BIOL4110).

- When you watch a Github repo, you get notifications when things happen in them. So if you "Watch" the BIOL4110 webpage repo, then you will get email notifications when I update the site! 

- The Issues page on a Github repo is a forum where Github users can bring up issues related to the repository.  
...
1. Go to your GitHub profile. Eg. Mine is [https://github.com/JoeyBernhardt](https://github.com/JoeyBernhardt). 
...
1. Name your repository `biol-4110-demo-YOUR-NAME`. In the description write "BIOL 4110 Demo".  Check the box for initializing the repository for adding a README file. 
...
1. Go back to your repository main page. Click on `README.md`, then click "edit this file". Add the following information into the `README.md` file: 
      - Your name 
      - What kind of student do you tell people you are at dinner parties? 
...
- At 9am, our TA pulls from the BIOL 4110 repository, makes a local change to the course dashboard, and commits and pushes his changes. 
- At 10am, I forget to pull from the BIOL 4110 repository, and start working on the Day 1 notes locally. 
- When I commit and push, Git is a bit confused, because I wasn't working off of the "freshest" version of the BIOL 4110 repository - but since our TA and I were working on different lines of code, it will fairly seamlessly figure out that the right thing to do is to add my changes to the Day 1 notes to the current version of the BIOL 4110 repository online. 

Here is an example of something that WOULD cause a merge conflict: 

- At 9am, our TA and I both pull from the BIOL 4110 repository. 
- At 10am, our TA  changes the front page to say "BIOL 4111", and commits/pushes those changes. 
- At 11am, I change the front page (without pulling!!!) to say "BIOL 4220".
- When I commit and push, Git doesn't know what to do. Should it make the version that says "BIOL 4111" or "BIOL 4220" the definitive version? The push will fail, and Git will tell us we need to fix the conflict and then commit the result. 
...
3. The stuff below the `<<<<<<<` and above the `=======` is what was in your local version; the stuff above the `>>>>>>>` and below the `=======` is what was in the remote conflicting version. Decide what you want to have on the offending line (e.g. "BIOL 4111), and replace the whole block of text above with that. 
