...
We'll show off how to use the `lubridate` package in the tidyverse to work with date variables in datasets in this [NYC Flights case study](/notes/supp-a10-solution.Rmd). 
